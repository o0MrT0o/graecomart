(() => {
  ...
  // node_modules/@capacitor-community/play-integrity/dist/esm/web.js
  var web_exports = {};
  __export(web_exports, {
    CapacitorPlayIntegrityWeb: () => CapacitorPlayIntegrityWeb
  });
  var CapacitorPlayIntegrityWeb;
  var init_web = __esm({
    "node_modules/@capacitor-community/play-integrity/dist/esm/web.js"() {
      init_dist();
      CapacitorPlayIntegrityWeb = class extends WebPlugin {
  ...
  // node_modules/@capacitor-community/play-integrity/dist/esm/index.js
  init_dist();
  var PlayIntegrity = registerPlugin("CapacitorPlayIntegrity", {
    web: () => Promise.resolve().then(() => (init_web(), web_exports)).then((m) => new m.CapacitorPlayIntegrityWeb())
  });
  ...
  async function requestIntegrityToken(nonce) {
    try {
      ...
      console.warn("[NativeIntegrity] requestIntegrityToken nie powi\xF3d\u0142 si\u0119:", err);
      return null;
    }
  }
