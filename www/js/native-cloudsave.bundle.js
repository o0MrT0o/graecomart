(() => {
  ...
  // node_modules/capacitor-google-game-services/dist/esm/web.js
  var web_exports = {};
  __export(web_exports, {
    GoogleGameServicesWeb: () => GoogleGameServicesWeb
  });
  var GoogleGameServicesWeb;
  var init_web = __esm({
    "node_modules/capacitor-google-game-services/dist/esm/web.js"() {
      init_dist();
      GoogleGameServicesWeb = class extends WebPlugin {
        signIn() {
  ...
  // node_modules/capacitor-google-game-services/dist/esm/index.js
  init_dist();
  var GoogleGameServices = registerPlugin("GoogleGameServices", {
    web: () => Promise.resolve().then(() => (init_web(), web_exports)).then((m) => new m.GoogleGameServicesWeb())
  });

  // native-cloudsave-src.js
  var SAVE_SLOT_TITLE = "ecomart_save";
  ...
  async function saveToCloud(jsonString) {
    try {
      ...
      console.warn("[NativeCloudSave] Zapis w chmurze nie powi\xF3d\u0142 si\u0119:", err);
      return false;
    }
  }
